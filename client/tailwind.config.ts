  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        ...
        'card': '0 4px 6px -1px hsl(222 47% 11% / 0.05), 0 2px 4px -2px hsl(222 47% 11% / 0.05)',
      ...
      keyframes: {
        ...
        "pulse-glow": {
          "0%, 100%": { boxShadow: "0 0 20px -5px hsl(142 71% 45% / 0.4)" },
          "50%": { boxShadow: "0 0 40px -5px hsl(142 71% 45% / 0.6)" },
        },
        "counter": {
          from: { opacity: "0", transform: "translateY(10px)" },
          to: { opacity: "1", transform: "translateY(0)" },
